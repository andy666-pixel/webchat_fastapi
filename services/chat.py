...
=======
    async def room(self, message: str):
>>>>>>> 73c8e1f (resuelto el 401 unautorized)
...
async def websocket_endpoint(websocket: WebSocket, autenticated_user: Annotated[User, Depends(get_current_active_user)], session: Session = Depends(SessionDep),):
>>>>>>> 73c8e1f (resuelto el 401 unautorized)
